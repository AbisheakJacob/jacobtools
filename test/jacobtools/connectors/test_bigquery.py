...
from JacobTools.exceptions.errors import ConfigurationError, QueryExecutionError
...
def connector(mock_bq_client):
    ...
    return GoogleBigQueryConnector(
        gcp_project_id="test-gcp-project-123",
        gbq_project_id="test-gbq-project-123"
        )
