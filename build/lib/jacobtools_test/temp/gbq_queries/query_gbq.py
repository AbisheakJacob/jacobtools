...
def query_gbq(query: str, str_gcp_project_id: str) -> pd.DataFrame:
    """
    ...
    df_table = pandas_gbq.read_gbq(
        query, project_id=str_gcp_project_id, dialect="standard", use_bqstorage_api=True
    )
